component extends="org.lucee.cfml.test.LuceeTestCase" labels="component,property,accessors" {
	...
	function run( testResults, testBox ) {
		...
		describe( "LDEV-6271: inherited property default + child UDF same name", function() {
			...
			it( title="internal variables.status read returns inherited parent default, not the UDF", skip=preLDEV6271, body=function() {
				var obj = new LDEV6271.InheritedDefaultChild();
				expect( obj.readStatusViaVariables() ).toBe( "parent-default" );
			});
