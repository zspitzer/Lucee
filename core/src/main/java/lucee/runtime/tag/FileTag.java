...
public final class FileTag extends BodyTagImpl {
	...
	private static Struct _actionUpload(PageContext pageContext, lucee.runtime.security.SecurityManager securityManager, FormItem formItem, String strDestination, int nameconflict,
		...
		cffile.set(KeyConstants.CfmlKeys._timelastmodified, new DateTimeImpl());
		cffile.set(KeyConstants.CfmlKeys._datelastaccessed, new DateImpl());
		cffile.set(KeyConstants.CfmlKeys._oldfilesize, Long.valueOf(length));
		cffile.set(KeyConstants.CfmlKeys._filesize, Long.valueOf(length));
		...
		cffile.set(KeyConstants.CfmlKeys._contenttype, ListFirst.call(pageContext, contentType, "/", false, 1));
		cffile.set(KeyConstants.CfmlKeys._contentsubtype, ListLast.call(pageContext, contentType, "/", false, 1));
		...
		cffile.set(KeyConstants.CfmlKeys._clientdirectory, getParent(clientFile));
		cffile.set(KeyConstants.CfmlKeys._clientfile, clientFile.getName());
		cffile.set(KeyConstants.CfmlKeys._clientfileext, ResourceUtil.getExtension(clientFile, ""));
		cffile.set(KeyConstants.CfmlKeys._clientfilename, ResourceUtil.getName(clientFile));
		...
		cffile.set(KeyConstants.CfmlKeys._serverdirectory, getParent(destination));
		cffile.set(KeyConstants.CfmlKeys._serverfile, destination.getName());
		cffile.set(KeyConstants.CfmlKeys._serverfileext, ResourceUtil.getExtension(destination, null));
		cffile.set(KeyConstants.CfmlKeys._serverfilename, ResourceUtil.getName(destination));
		cffile.set(KeyConstants.CfmlKeys._attemptedserverfile, destination.getName());
		...
		if (nameconflict == NAMECONFLICT_FORCEUNIQUE) {
			...
			cffile.set(KeyConstants.CfmlKeys._serverdirectory, getParent(destination));
			cffile.set(KeyConstants.CfmlKeys._serverfile, destination.getName());
			cffile.set(KeyConstants.CfmlKeys._serverfileext, ResourceUtil.getExtension(destination, ""));
			cffile.set(KeyConstants.CfmlKeys._serverfilename, ResourceUtil.getName(destination));
		}
		...
		if (destination.exists()) {
			...
			if (nameconflict == NAMECONFLICT_ERROR) {
				...
				cffile.set(KeyConstants.CfmlKeys._fileexisted, Caster.toBoolean(fileExisted));
				cffile.set(KeyConstants.CfmlKeys._filewasappended, Boolean.FALSE);
				cffile.set(KeyConstants.CfmlKeys._filewasoverwritten, Boolean.FALSE);
				cffile.set(KeyConstants.CfmlKeys._filewasrenamed, Boolean.FALSE);
				cffile.set(KeyConstants.CfmlKeys._filewassaved, Boolean.FALSE);
				return cffile;
			}
		...
		cffile.set(KeyConstants.CfmlKeys._fileexisted, Caster.toBoolean(fileExisted));
		cffile.set(KeyConstants.CfmlKeys._filewasappended, Caster.toBoolean(fileWasAppended));
		cffile.set(KeyConstants.CfmlKeys._filewasoverwritten, Caster.toBoolean(fileWasOverwritten));
		cffile.set(KeyConstants.CfmlKeys._filewasrenamed, Caster.toBoolean(fileWasRenamed));
		cffile.set(KeyConstants.CfmlKeys._filewassaved, Boolean.TRUE);
