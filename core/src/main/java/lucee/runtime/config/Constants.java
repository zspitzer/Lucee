...
public class Constants {
	...
	public static final String[] DTDS_FLD = new String[]{
		"-//Lucee//DTD CFML Function Library 1.0//EN",
		"-//Railo//DTD CFML Function Library 1.0//EN"};
	
	public static final String[] DTDS_TLD = new String[]{
		"-//Lucee//DTD CFML Tag Library 1.0//EN",
		"-//Railo//DTD CFML Tag Library 1.0//EN"};
