...
public class GeneratePBKDFKey extends BIF {
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		if ( args.length == 5) return call( pc, Caster.toString(args[0]),Caster.toString(args[1]), Caster.toString(args[2]),Caster.toDoubleValue(args[3]),Caster.toDoubleValue(args[4]));
